...
@patch('gonzo.scripts.stack.template.get_parsed_document')
def test_launch(get_parsed_doc, wait_for_stack_complete, print_stack,
                cloud_fixture, minimum_config_fixture):
